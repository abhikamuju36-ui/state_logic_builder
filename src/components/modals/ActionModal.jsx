            ...
            <div className="device-select-grid">
              {devices.map(d => {
                ...
                return (
                  ...
                  >
                    <span className="device-select-card__icon"><DeviceIcon type={d.type} size={22} /></span>
          ...
          {deviceId && operation && (
            <div className="props-info-box" style={{ marginTop: 12 }}>
              ...
              <div className="props-info-box__value">
                <span style={{ marginRight: 6, display: 'inline-flex', verticalAlign: 'middle' }}><DeviceIcon type={selectedDevice?.type} size={18} /></span>
