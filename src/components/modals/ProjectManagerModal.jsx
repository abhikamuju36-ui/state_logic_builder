...
export function ProjectManagerModal() {
  ...
  async function handleSwitch(filename) {
    ...
    // switchProject closes modal on success
  }
  ...
  return (
    <div className="modal-overlay" onClick={(e) => {
      ...
      <div className="modal" style={{ width: 520 }}>
        ...
        <div className="modal__body" style={{ padding: '16px 20px' }}>
          ...
          {!loading && projects.length === 0 && (
            ...
            <div style={{
              ...
              gap: 10, padding: '14px 16px', marginBottom: 10,
              background: '#eff6ff', border: '1.5px solid #2563eb', borderRadius: 6,
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6, maxHeight: 400, overflowY: 'auto', opacity: switching ? 0.5 : 1, pointerEvents: switching ? 'none' : 'auto' }}>
            {projects.map(p => {
